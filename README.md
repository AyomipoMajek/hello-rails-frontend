...
**Hello React Front End** is the front-end of a project, which is built using both back-end and front-end. The Rails back-end can be found <a href="https://github.com/AyomipoMajek/hello-rails-backend" >here</a>.
...
```sh
  git clone https://github.com/AyomipoMajek/hello-rails-frontend.git
